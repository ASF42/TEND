...
$(function(){
	...
	$("header .menu .parent>.nav-link").on('click', function(e) {
		  e.preventDefault();
		  $("header #menu .parent.show").not($(this).parents(".parent")).removeClass("show");
		  $(this).parents(".parent").toggleClass("show");
		  $(this).siblings(".submenu").removeClass("hide");
		  if ($("header #menu .parent.show").length) $("header").addClass('active');
	...
	let $tr,i;
	$("#tableBody td").hover(function(){
		$tr = $(this).parents("tr").children();
		i = $tr.index(this);
		$("#tableBody tr").each(function(){$(this).children().eq(i).addClass("hover");});
		$tr.addClass("hover");
	},function(){
		$tr.removeClass("hover");
		$("#tableBody tr").each(function(){$(this).children().eq(i).removeClass("hover");});
	});
	
	$("#tableBody th").hover(function(){
		$tr = $(this).parents("tr").children();
		$tr.addClass("hover");
	},function(){
		$tr.removeClass("hover");
	 ...
	 if($("#tableBody").length){
		 FixFullHeightTable();
	 	$(window).on('resize',FixFullHeightTable);
	 }
...
$(document).ready(function(){
	//$("header .menu .submenu.hide").removeClass("hide");
});
...
$(window).scroll(function() {
	...
	else{$("header").removeClass("hide scroll");}
});
